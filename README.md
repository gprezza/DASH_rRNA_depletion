# DASH_rRNA_depletion
Python tool to design sgRNA pools targeting the rRNA genes. Example input and output files for Salmonella Typhimurium (gff annotation) and Bacteroides thetaiotaomicron (custom rRNA annotation) are present in the "example_files" folder.
...
* If you already have bowtie indexes of these sequences, put them in a subfolder named bowtie_files/. If you don't, the folder and the indexes will be generated by the script.
